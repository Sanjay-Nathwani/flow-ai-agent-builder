              ...
              {group.items.map((nodeType) => {
                ...
                return (
                  <button
                    ...
                    disabled={false}
                    className={cn(
                      "flex items-center gap-3 p-1.5 hover:bg-accent transition-all cursor-grab active:cursor-grabbing disabled:opacity-50 disabled:pointer-events-none w-full",
                    )}
                  >
                    <div
                      className={cn(
